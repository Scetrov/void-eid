...
mod tests {
    ...
    fn address_parsing_accepts_lowercase_hex() {
        ...
        assert_eq!(
            parsed,
            [
                0x08, 0x81, 0xc0, 0x75, 0x20, 0x94, 0x3b, 0xbf, 0x13, 0x98, 0x9b, 0x92, 0x89,
                0x20, 0x93, 0xc1, 0xb5, 0x06, 0x72, 0x15, 0x6f, 0xa5, 0xf8, 0x73, 0xc2, 0x28,
                0x92, 0x70, 0x1c, 0xb2, 0xe2, 0x07
            ]
        );
    }
    ...
    fn address_parsing_rejects_invalid_hex() {
        assert!(parse_address("0xzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzz").is_err());
    }
}
