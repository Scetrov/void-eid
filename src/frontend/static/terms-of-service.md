...
By accessing or using VoID eID, you agree to be bound by these Terms. If you disagree with any part of the terms, you may not access the Service.

## 2. Description of Service

VoID eID is a verification tool that allows users to cryptographically link their Discord account to a Sui Blockchain wallet.
...
To the maximum extent permitted by law, the VoID eID team shall not be liable for any indirect, incidental, special, or consequential damages resulting from your use of the Service or any unauthorized access to your data.
