...
import { getExplorerUrl, getNetworkLabel } from '../../utils'
                            ...
                            member?.wallets.map((wallet) => (
                                <div key={wallet.id} style={{
                                    ...
                                    <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '0.5rem' }}>
                                        ...
                                        <a
                                            href={getExplorerUrl(wallet.network || 'mainnet', wallet.address)}
                                            target="_blank"
                                            rel="noopener noreferrer"
                                            style={{ color: 'var(--text-secondary)', display: 'flex', alignItems: 'center', gap: '0.25rem', fontSize: '0.85rem' }}
                                    ...
                                    <CopyableField
                                        ...
                                        style={{
                                            textDecoration: wallet.deletedAt ? 'line-through' : 'none',
                                            opacity: wallet.deletedAt ? 0.7 : 1
                                        }}
                                    />
                                </div>
                            ))
